...
export const ALL_STATUSES = ["未確認", "検討中", "返信待ち", "返信済み", "保留", "成立", "不成立", "非依頼"];
// 「返信待ち」は返信済み/保留/成立の案件に新着返信が来た時に自動で付く(supabase/inquiry_waiting_reply_status.sql
// のappend_thread_message参照)ため、未確認・検討中と同じく対応が必要な案件としてデフォルト表示に含める。
export const DEFAULT_VISIBLE_STATUSES = ["未確認", "検討中", "返信待ち"];
